...
const fs = require('fs');
const Codechef = require('../database/Schema/codechef');
        ...
        fs.readFile(path.join(__dirname, '../json/codechef.json'), 'utf-8', async (err, data) => {
            if (data) {
                ...
                for (var k = 0; k < data.length; k++) {                    
                    ...
                    if (findDate(data[k].day.toString()) == d.getDate()  && notifyMiliSecond-Date.now()>= -600000) { 
                        ...
                        console.log('codechef: ', notifyMiliSecond - Date.now() - 600000);
                    }
                }
            }
        })
